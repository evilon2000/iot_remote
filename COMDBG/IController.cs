...
namespace COMDBG
{
    ...
    public class IController
    {
        ...
        public string ReadDataFromCom(int len)
        {
            return comModel.Read(len);
        }
        /// <summary>
        ...
        public void StopBatchModle()
        {
            comModel.AddReciveEvent();
            comModel.SetExpireTime(-1);
        }

        /// <summary>
        /// mbus reading time-out define
        /// </summary>
        public void StartBatchModle()
        {
            comModel.RemoveReciveEvent();
            comModel.SetExpireTime(10000);
        }
        public static void CallWithTimeout(Action<int> action, int timeoutMilliseconds,int len)
        {
