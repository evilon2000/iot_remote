...
namespace COMDBG
{
    ...
    public class ComModel
    {
        ...
        public void RemoveReciveEvent()
        {
            sp.DataReceived -= new SerialDataReceivedEventHandler(DataReceived);
        }
        public void AddReciveEvent()
        {
            sp.DataReceived += new SerialDataReceivedEventHandler(DataReceived);
        }
        public string Read(int lenght)
        {
            IController.CallWithTimeout(WaitComReader,sp.ReadTimeout,lenght);
            int len = sp.BytesToRead;
            Byte[] data = new Byte[len];
            try
            {
            ...
            return IController.Bytes2Hex(data);
        }

        private void WaitComReader(int len)
        {
        ...
        public void SetExpireTime(int timeOut)
        {
